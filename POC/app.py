...
with st.sidebar:
    ...
    with st.form("my_form"):
        origin = st.text_input("📍 From where will you be traveling from?",placeholder="Boston,US")
        destination = st.text_input("🏝️ Which location you are interested in visiting?",placeholder="Miami, US")
